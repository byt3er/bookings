...
--
-- Name: room_restrictions_start_dt_end_dt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX room_restrictions_start_dt_end_dt_idx ON public.room_restrictions USING btree (start_date, end_date);
